...
WIFI_SSID = const("Star Khan")
WIFI_PASSWORD = const("Starwifi@6174")
MQTT_SERVER = const("192.168.0.111")
TCP_PORT = const(1883)
CLIENT_ID = const("ESP32-NODE1")
MQTT_USER = const("fedora")
MQTT_PASSWORD = const("fedora@6174")
ENV_TOPIC = const("ENV_DATA")
RFID_TOPIC = const("RFID_DATA")
FACE_TOPIC = const("FACE_DATA")
MUSIC_TOPIC = const("MUSIC_DATA")
CONTROL_TOPIC = const("CONTROL_DATA")
CLUSTER_ID = const(1)
